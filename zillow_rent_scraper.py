...
# Original GitRepo for reference/credits https://gist.github.com/scrapehero/5f51f344d68cf2c022eb2d23a2f1cf95
...
def create_url(zipcode, filter=None):
    # Creating Zillow URL based on the filter.
    url = "https://www.zillow.com/seattle-wa/2_p/"
    '''    if filter == "newest":
...
def parse(zipcode, filter=None):
    ...
    # Adding to see output of parser
...
if __name__ == "__main__":
    ...
    '''    argparser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter)
        argparser.add_argument(zipcode='92115', help='')       #'zipcode'
        sortorder_help = """
        ...
        argparser.add_argument(sort='cheapest', nargs='?', help=sortorder_help, default='Homes For You')
        args = argparser.parse_args()
        zipcode = args.zipcode
        sort = args.sort
        print ("Fetching data for %s" % (zipcode))'''
    scraped_data = parse(zipcode='27103')#, sort='newest')
    if scraped_data:
